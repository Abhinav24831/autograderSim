 ...
 * Sources used: None
 * 
 * The file holds the Ticket class. Ticket objects are used in the Autograder
 * class.
 */
...
public class Ticket implements Comparable<Ticket>{
    ...
    public int compareTo(Ticket other){
        //TODO: Your code 
        if(orderMap.get(this.ticketType).equals
        (orderMap.get(other.ticketType)) == true &&
        this.createdAt.equals(other.createdAt) == false){
            return (int)(this.createdAt - other.createdAt);
        }  

        return orderMap.get(this.ticketType) - orderMap.get(other.ticketType);
    }
